...
public class $Proxy0Dump implements Opcodes {
    ...
    public static byte[] dump() throws Exception {
        ...
        cw.visit(52, ACC_PUBLIC + ACC_SUPER, "com/sgming/$Proxy0", null, "java/lang/reflect/Proxy", new String[]{"com/sgming/Foo"});
        ...
        }
        {
            ...
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, "com/sgming/$Proxy0", "h", "Ljava/lang/reflect/InvocationHandler;");
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETSTATIC, "com/sgming/$Proxy0", "foo", "Ljava/lang/reflect/Method;");
        ...
        }
        {
            ...
            mv.visitFieldInsn(PUTSTATIC, "com/sgming/$Proxy0", "foo", "Ljava/lang/reflect/Method;");
            mv.visitLabel(l1);
