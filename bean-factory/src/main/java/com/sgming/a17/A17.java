...
public class A17 {
    public static void main(String[] args) {
        ...
        /*
            第一个重要的方法 findEligibleAdvisors 找到有【资格】的Advisors
                - 有【资格】的advisor一部分是低级的，可以由自己编写，如下例的advisor3
                - 有【资格】的Advisor另一部分是高级的，有本章的主角解析@Aspect后获得
            因为 findEligibleAdvisors 方法是 protected 所以请在 org.springframework.aop.framework.autoproxy 包下查看 A17
         */
